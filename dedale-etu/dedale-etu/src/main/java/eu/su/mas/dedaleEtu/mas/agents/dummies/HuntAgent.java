...
public class HuntAgent extends AbstractDedaleAgent {
	...
	protected void setup(){
		...
		lb.add(new HuntFSMBehaviour(this));
	...
	public void mergeMap(SerializableSimpleGraph<String, MapAttribute> sgreceived, AID senderID){
		this.mapManager.mergeMap(sgreceived, senderID);
	}
